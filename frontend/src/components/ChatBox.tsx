...
export default function ChatBox({ messages, onSend, loading, useRag, onToggleRag }: ChatBoxProps) {
    ...
    return (
        <div className="flex flex-col h-full bg-gray-50">
            {/* Header */}
            <div className="sticky top-0 z-10 h-14 bg-white/80 backdrop-blur-md border-b border-gray-200 px-4 flex items-center">
                <div className="w-full flex items-center justify-between">
                    ...
                    <div className="flex items-center bg-gray-100 p-1 rounded-lg border border-gray-200">
                        ...
                        <button
                            ...
                            className={`px-4 py-1.5 rounded-md text-sm font-medium transition-all ${useRag ? "bg-indigo-600 text-white shadow-sm" : "text-gray-500 hover:text-gray-700"
                                }`}
                        >
                            RAG Mode
                        </button>
                ...
                <div className="max-w-5xl mx-auto px-4 py-8 space-y-8">
                    {messages.length === 0 && (
                        <div className="flex flex-col items-center justify-center h-[60vh] text-gray-400">
                            <div className="p-4 bg-white rounded-full shadow-sm mb-4 border border-gray-200">
                    ...
                    {messages.map((msg, idx) => (
                        ...
                        >
                            ...
                            {msg.role === "user" && (
                                <div className="flex-shrink-0 w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center mt-1 shadow-sm">
            ...
            {/* Input */}
            <div className="bg-white/80 backdrop-blur-md border-t border-gray-200 p-4 pb-6">
                <div className="max-w-5xl mx-auto relative">
                    <form onSubmit={handleSubmit} className="relative shadow-lg rounded-2xl bg-white border border-gray-200 hover:border-indigo-400 transition-colors focus-within:border-indigo-500 focus-within:ring-4 focus-within:ring-indigo-500/10 outline-none">
                        <input
                            type="text"
                            value={input}
                        ...
                        <button
                            ...
                            className="absolute right-2 top-2 p-2 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-not-allowed transition-all active:scale-95"
                        >
